...
<img width="791" height="388" alt="image" src="https://github.com/user-attachments/assets/2f194c22-e44e-4718-895d-0a5e497617a6" />


Data Integration:  
Combined the review dataset with country level data using a shared country field to support richer geographic analysis and reporting.

Dynamic Parameters:  
Created a dynamic parameter to allow users to switch between review metrics such as overall rating, food, entertainment, and seat comfort. This made the dashboard more flexible and user driven.
...
Added interactive filters for month, traveller type, seat type, continent, and aircraft to support focused analysis.
